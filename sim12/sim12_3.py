...
for i in range(length):
  x.append(i+1)
  menu1=au1[i]*distance1[i]*road[i]*wether[i]
  menu2=au2[i]*distance2[i]*road[i]*wether[i]
  menu3=au3[i]*distance3[i]*road[i]*wether[i]
